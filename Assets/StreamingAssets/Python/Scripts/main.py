...
# TODO оптимизировать расход памяти (memory_profile)
# TODO добавить возможность произвольного выбора, расчитывать ли значения по времени для электрополей
# TODO распараллелить вычисления точек (asyncio)
